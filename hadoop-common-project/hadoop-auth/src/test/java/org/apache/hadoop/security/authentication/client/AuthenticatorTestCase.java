...
public class AuthenticatorTestCase {
  ...
  private SystemDefaultHttpClient getHttpClient() {
    ...
    httpClient.getAuthSchemes().register(AuthPolicy.SPNEGO, new SPNegoSchemeFactory(true) {
      ...
      class SPNegoSchemeForIBMJVM extends SPNegoScheme {

        public SPNegoSchemeForIBMJVM(boolean stripPort) {
          super(stripPort);
        }
        ...
        protected byte[] generateGSSToken(byte[] input, Oid oid, String authServer) throws GSSException {
          ...
          GSSContext gssContext = manager.createContext(
                  serverName.canonicalize(oid), oid, null, 86400000);
      ...
      public AuthScheme newInstance(HttpParams params) {
        if (IBM_JAVA) {
          return new SPNegoSchemeForIBMJVM(isStripPort());
        } else {
          return super.newInstance(params);
        }
      }
